...
def insert_sample_data(table_name):
    sample_data = [
        ('1', 'poojamma', '123-456-7890', 'poo@example.com'),
        ('2', 'dave', '987-654-3210', 'dave@example.com'),
        ('3', 'niveditha ', '555-123-4567', 'nive@example.com'),
        ('4', 'aishwarya', '999-888-7777', 'aish@example.com'),
        ('5', 'shravya', '444-555-6666', 'shrav@example.com')
    ]
